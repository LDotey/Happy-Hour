...
# Add cocktails for testing
    ...
    Cocktail.create("Vodka Martini", "Vodka, Dry Vermouth", "Add vodka and dry vermouth to a shaker of ice. After shaking, strain into a chilled glass. Garnish with lemon peel", 5)
